...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        private Coroutine m_SelectionFillRoutine = null;                                               // Used to start and stop the filling coroutine based on input.
        ...
        public void HandleDown()
        {
            ...
            if (m_IsSelectionRadialActive && m_SelectionFillRoutine == null)
            {
